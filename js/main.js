...
var _iterator = _createForOfIteratorHelper(document.querySelectorAll("._text")),
  _step;
try {
...
var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll("._link")),
  _step2;
try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    var _link = _step2.value;
    _link.addEventListener("mouseover", letterScramble, false);
  }
} catch (err) {
  _iterator2.e(err);
} finally {
...
document.querySelector(".siteHeader_title").addEventListener("mouseover", letterScramble, false);
...
function hidePage(page) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(page, {
    opacity: 0,
    duration: 0.3,
...
function showPage(page) {
  page.style.display = "block", gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(page, {
    opacity: 0
  }, {
    opacity: 1,
    duration: 0.9
...
var images = importAll(__webpack_require__("./src/images sync \\.(png%7Cjpe?g%7Csvg)$"));
})();
